...
t.add_output(Output(
    ...
    Export=Export(Join("-", [Select(0, Split("-CF-Stack", Ref("AWS::StackName"))), "id"])),
))
...
t.add_output(Output(
    ...
    Export=Export(Join("-", [Select(0, Split("-CF-Stack", Ref("AWS::StackName"))), "vpc-id"])),
))
...
t.add_output(Output(
    ...
    Export=Export(Join("-", [Select(0, Split("-CF-Stack", Ref("AWS::StackName"))), "public-subnets"])),
))
